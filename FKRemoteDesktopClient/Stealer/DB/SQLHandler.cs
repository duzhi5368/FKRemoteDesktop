...
//--------------------------------------------------------------------------------------
namespace FKRemoteDesktop.Stealer.DB
{
    public class SQLHandler
    {
        ...
        public string GetValue(int rowNum, string name)
        {
            ...
            {
                if(_fieldNames[i].Equals(name, StringComparison.OrdinalIgnoreCase))
                {
                    return GetValue(rowNum, i);
                }
            }
            return null;
        }
        ...
        public string GetFieldName(int rowNum)
        {
            try
            {
                if (rowNum >= _fieldNames.Length)
                    return (string)null;
                return _fieldNames[rowNum];
            }
            catch { return null; }
        }
